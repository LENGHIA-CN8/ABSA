from explore_data.data_utils import preprocess, extract_info_from_file, check_unrelated_sentence
import os
import json
import argparse
...
def main(args):
    ...
    for doc in all_documents:
        ...
        for sentence in new_sentences:
            ...
            assert len(char_to_word_offset) == len(sentence.text), "{} || {}".format(len(char_to_word_offset), len(sentence.text))

            new_sentence['tokens'] = doc_tokens
            new_sentence['terms'] = {}
            for term_id in sentence.terms:
                if "EOS" == sentence.terms[term_id]['term'][0].text and "unclear" == sentence.terms[term_id]['attribute'][0].category:
                    continue
                ...
                for term in sentence.terms[term_id]['term']:
                    ...
                    try:
                        ...
                        print(term.start_pos, len(char_to_word_offset))
