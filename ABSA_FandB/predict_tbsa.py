...
def main():
    ...
    dataset = convert_examples_to_dataset(examples, args.label_dict, args.max_length, tokenizer, args.stride, args.replace_term_with_mask)
    ...
    def eval(model, data):
        ...
        for batch in tqdm(data, desc= "Evaluation"):
            ...
            loss, logits = model(input_ids, attention_mask, target_masks, labels, args.data_mode, args.pool_type, args.label_weights)
