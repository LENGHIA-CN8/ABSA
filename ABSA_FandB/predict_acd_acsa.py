...
def main():
    ...
    dataset = convert_examples_to_dataset(examples, args.aspect_type_dict, args.aspect_sentiment_dict, args.max_length, tokenizer, args.stride, args.replace_term_with_mask)
